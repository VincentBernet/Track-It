		...
		<Layout>
			<div className="container" id="fore-particles">
				<svg className="moko-404" viewBox="0 0 500 400">
					...
					/>
					<ellipse cx="244.9" cy="176.2" className="moko-404__c" rx="11.5" ry="13.8" />
					<path d="M70 373.3l18.2-214L157 5.3h7.7L97.2 160.7l7 213.4" className="moko-404__d" />
					<path
					...
					/>
					<path d="M348.6 291.2L365 268l2.3-33.5 3.8-1.6-.7 36.4-17 53.6" className="moko-404__f" />
					<path
					...
					<path
						...
						className="moko-404__b"
					/>
					<path d="M273 127.5a24 24 0 0 0-2.4 5c-1.3 3.3-1.2 10-1.2 10L266 131z" className="moko-404__b" />
					<ellipse
						cx="280.8"
						cy="116.9"
						className="moko-404__c"
					...
					/>
					<path d="M249.7 135.3a28.6 28.6 0 0 1 0-6.2l-8.3.8v5.4a21.2 21.2 0 0 0 8.2 0z" className="moko-404__a" />
					<path
						...
						className="moko-404__b"
					/>
					<path d="M236.6 82s5.7 7.8 7.6 20.6l8.6-20.5a34 34 0 0 0-16.2 0" className="moko-404__c" />
					<path
					...
					<path
						...
						className="moko-404__b"
					/>
					<path d="M218 127.5a24 24 0 0 1 2.6 5c1.3 3.3 1.3 10 1.3 10l3.4-11.4z" className="moko-404__b" />
					<ellipse
						cx="218.1"
						cy="118.3"
						className="moko-404__c"
					...
					<path d="M91.5 376.6s6.6-8.6 15-8.6 16 .4 16 .4l8.6 7.4s-13 2-39.5.8z" className="moko-404__j" />
					<path
					...
					/>
					<path className="stemO1 moko-404__f" d="M51.86,264.27s-7-28.29-6.13-29.09,7.56,28.39,7.56,28.39" />
					<path
						className="leafN1 moko-404__j"
						d="M316.78,81.48s-20-28.31,1-68.33C317.75,13.15,342.16,46.34,316.78,81.48Z"
					/>
					<path className="stemN1 moko-404__g" d="M315.31,97.59s2.44-54.18,4.39-55.15-1.46,54.67-1.46,54.67" />
					<path
					...
					/>
					<path className="stemL1 moko-404__f" d="M184.15,193s-10.1-13.39-9.87-13.84,10.6,13.38,10.6,13.38" />
					<path
						className="leafK1 moko-404__j"
						d="M52.09,256.5c-.14,1.32,14.4-.31,17.68-17.63C69.77,238.87,53.74,240.51,52.09,256.5Z"
					/>
					<path className="stemK1 moko-404__f" d="M51.64,256.37s10.85-12,11.4-11.84S52.3,257.09,52.3,257.09" />
					<path
						className="leafJ1 moko-404__j"
						d="M345.32,250.15s15.19-15.25,6.5-41.94C351.82,208.21,333.43,226,345.32,250.15Z"
					/>
					<path className="stemJ1 moko-404__f" d="M344.54,260.16s4.13-33.43,3-34.23-4.78,33.62-4.78,33.62" />
					<path
						className="leafI1 moko-404__j"
						d="M343.21,251.28c.34,1.5-16.57,1.62-22.71-17.8C320.5,233.47,339.12,233.15,343.21,251.28Z"
					/>
					<path className="stemI1 moko-404__f" d="M343.71,251.07s-14.1-12.29-14.71-12S343,252,343,252" />
					<path
					...
					/>
					<path className="stemG1 moko-404__g" d="M150,257.08s14.88-18,15.36-17.78c.88.49-13.85,18.78-13.85,18.78" />
					<path
						className="leafF1 moko-404__m"
						d="M100.49,197.69c1,1.14,10.91-12-.74-28.18C99.75,169.52,88.66,183.94,100.49,197.69Z"
					/>
					<path className="stemF1 moko-404__g" d="M100.71,206.91s-2.16-27.31-1.54-27.48c1.14-.3,3.63,27.1,3.63,27.1" />
					<path
					...
					/>
					<path className="stemD1 moko-404__g" d="M256.55,334.2s-4.67-21.57-5.18-21.55c-.95,0,3.48,21.74,3.48,21.74" />
					<path
						className="leafC1 moko-404__f"
						d="M31.65,304c.78.43,3.56-9-6.29-15.53C25.37,288.44,22.2,298.78,31.65,304Z"
					/>
					<path className="stemC1 moko-404__g" d="M33.7,309.06s-6.9-14.75-6.59-15c.57-.41,7.67,14.33,7.67,14.33" />
					<path
						className="leafB1 moko-404__f"
						d="M463.8,301.91c.38.81,8.14-5.21,4-16.27C467.77,285.64,459.16,292.18,463.8,301.91Z"
					/>
					<path className="stemB1 moko-404__g" d="M462.49,307.24s3-16,3.4-16c.7,0-2.14,16.11-2.14,16.11" />
					<path
						className="leafA1 moko-404__f"
						d="M448.21,277.22c-.07,1.17,12.66-.84,14.87-16.2C463.07,261,449,263.08,448.21,277.22Z"
					/>
					<path className="stemA1 moko-404__g" d="M443.33,282.5s13.6-16.49,14-16.25c.8.45-12.66,17.17-12.66,17.17" />

					<path
						className="leafO2 moko-404__j"
						d="M49.29,255.07S33,246,33.93,221.71C33.93,221.71,53.45,232.15,49.29,255.07Z"
					/>
					<path className="stemO2 moko-404__f" d="M52.31,263.22s-11.37-26.83-10.65-27.76,12,26.84,12,26.84" />
					<path className="leafN2 moko-404__j" d="M315.63,81.49s-23-26-6.48-68C309.15,13.46,337,43.79,315.63,81.49Z" />
					<path className="stemN2 moko-404__g" d="M315.93,97.66s-3.48-54.12-1.65-55.3,4.5,54.5,4.5,54.5" />
					<path
					...
					/>
					<path className="stemL2 moko-404__f" d="M183.47,192.07s-5.5-15.85-5.14-16.2,6,16,6,16" />
					<path
						className="leafK2 moko-404__j"
						d="M52.44,257.67c.06,1.33,14.2-2.42,14.9-20C67.34,237.64,51.72,241.61,52.44,257.67Z"
					/>
					<path className="stemK2 moko-404__f" d="M52,257.61s9-13.47,9.54-13.38-8.78,14-8.78,14" />
					<path
						className="leafJ2 moko-404__j"
						d="M344.81,250.2s14.72-15.71,5.23-42.12C350,208.08,332.19,226.41,344.81,250.2Z"
					/>
					<path className="stemJ2 moko-404__f" d="M344.34,260.23s3.12-33.54,2-34.3-3.76,33.75-3.76,33.75" />
					<path
						className="leafI2 moko-404__j"
						d="M343.49,251.73c0,1.54-16.54-1.89-18.48-22.17C325,229.56,343.29,233.15,343.49,251.73Z"
					/>
					<path className="stemI2 moko-404__f" d="M344,251.63s-11.22-15-11.86-14.84,11,15.6,11,15.6" />
					<path
					...
					/>
					<path className="stemF2 moko-404__g" d="M101.89,207.31s-8.24-26.13-7.67-26.43c1-.55,9.62,25.59,9.62,25.59" />
					<path
						className="leafE2 moko-404__m"
						d="M415.95,181.54c1.18.28,1.41-13-13.82-18C402.13,163.53,401.72,178.18,415.95,181.54Z"
					/>
					<path className="stemE2 moko-404__g" d="M420.46,187.44s-14.34-16.78-14-17.18c.6-.74,15.2,15.94,15.2,15.94" />
					<path
						className="leafD2 moko-404__m"
						d="M253.48,326.64c-.35,1.16-12-5.29-8.68-21C244.8,305.67,257.68,312.64,253.48,326.64Z"
					/>
					<path className="stemD2 moko-404__g" d="M256.34,333.49s-7.35-20.8-7.87-20.72c-.94.15,6.2,21.12,6.2,21.12" />
					<path
						className="leafC2 moko-404__f"
						d="M30.73,305.66c.89,0-.67-9.64-12.39-11.28C18.35,294.38,20,305.07,30.73,305.66Z"
					/>
					<path className="stemC2 moko-404__g" d="M34.78,309.36S22.17,299,22.36,298.71c.34-.61,13.11,9.6,13.11,9.6" />
					<path
						className="leafB2 moko-404__f"
						d="M463.63,302.34c.19.87,9.1-3.24,7.53-15C471.16,287.38,461.3,291.81,463.63,302.34Z"
					/>
					<path className="stemB2 moko-404__g" d="M461.16,307.23s6.54-14.91,6.91-14.83c.68.16-5.71,15.21-5.71,15.21" />
					<path
						className="leafA2 moko-404__f"
						d="M447.56,278.48c-.23,1.15,12.65.92,17-14C464.53,264.48,450.33,264.59,447.56,278.48Z"
					/>
					<path className="stemA2 moko-404__g" d="M442,283s15.75-14.46,16.15-14.15c.73.55-14.91,15.26-14.91,15.26" />
					...
					<path className="eyeL3   moko-404__k" d="M227.67,97.39H205.81a.5.5,0,0,1,0-1h21.85a.5.5,0,1,1,0,1Z" />
					<path className="eyeR3   moko-404__k" d="M283,97.39H261.27a.5.5,0,0,1,0-1H283a.5.5,0,0,1,0,1Z" />
					<path
