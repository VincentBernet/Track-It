type DoubleSortSvgProps = {
	fillBottom?: boolean;
	fillTop?: boolean;
};

/* https://www.svgrepo.com/svg/533713/sort */
const DoubleSortSvg = ({ fillBottom, fillTop }: DoubleSortSvgProps) => {
	return (
		<svg width="20px" height="25px" fill="none">
			<title>Double Sort Icon</title>
			<path
				stroke="var(--white)"
				strokeWidth="1.3"
				strokeLinecap="round"
				strokeLinejoin="round"
				fill={fillTop ? "var(--white)" : "none"}
			...
			<path
				...
				strokeLinecap="round"
				strokeLinejoin="round"
				fill={fillBottom ? "var(--white)" : "none"}
